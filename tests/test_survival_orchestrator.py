...
from src.orchestration.survival_model import SurvivalModelSingleton, INCIDENT_TYPE_MAP, PRIORITY_MAP, HISTORICAL_MEDIANS
...
async def test_survival_model_fallback_on_invalid_data():
    ...
    assert response.predictions["module_a"]["duration_estimate"] == HISTORICAL_MEDIANS["generic_fallback"]
