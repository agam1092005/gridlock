...
class CircuitBreaker:
    ...
    def _should_open(self) -> bool:
        ...
        if self.latencies:
            ...
            if avg_latency > self.latency_threshold_ms:
                if (self.failure_count + self.success_count) >= self.failure_count_threshold:
                    logger.warning(
                        f"Circuit breaker '{self.name}' detected high latency",
                        extra={
                            "cb_latency_ms": avg_latency,
    ...
    def call(self, func: Callable[..., T], *args, **kwargs) -> T:
        ...
        try:
            ...
            # Check if volume and error/latency thresholds require opening
