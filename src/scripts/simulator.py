...
def generate_random_incident(dataset_rows=None):
    ...
    if dataset_rows:
        ...
        incident_type = cause if cause in ["accident", "congestion", "road_closure", "hazard", "event"] else "event"
    ...
    while True:
        ...
        try:
            ...
            if response.status_code == 202:
                print(f"[+] Successfully generated incident: {incident['incident_id']} (Type: {incident['incident_type']})")
            else:
