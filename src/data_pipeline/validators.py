...
class DuplicateDetector:
    ...
    def add_incident(
        self, incident_id: str, location: Dict[str, float], timestamp: datetime, incident_type: str
    ) -> None:
        """
...
class IncidentValidator:
    ...
    def validate_single(
        self, incident_data: Dict[str, Any], incident_id: Optional[str] = None
    ) -> ValidationResult:
        """
        ...
        try:
            ...
            logger.error(
                ...
                exc_info=True,
                extra={"incident_id": incident_id or "unknown", "error": str(e)},
            )
    ...
    def _validate_location_service_area(
        self, incident: IncidentInput, aggregator: ErrorAggregator
    ) -> None:
        """
        ...
        if not (
            SYDNEY_LAT_MIN <= lat <= SYDNEY_LAT_MAX and SYDNEY_LON_MIN <= lon <= SYDNEY_LON_MAX
        ):
            aggregator.add_error(
                field="location",
    ...
    def validate_with_context(
        self, incident_data: Dict[str, Any], context: Optional[Dict[str, Any]] = None
    ) -> ValidationResult:
        """
